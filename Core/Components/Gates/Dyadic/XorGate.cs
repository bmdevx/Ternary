...
{
    //XOR
    public class XorGate : DyadicBaseGate
    {
        public XorGate(IComponentOutput componentA, IComponentOutput componentB, Trit inputStateA = Trit.Neu, Trit inputStateB = Trit.Neu) :
