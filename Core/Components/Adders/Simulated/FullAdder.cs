...
{
    public class FullAdder : HalfAdder
    {
        ...
        public FullAdder(IEnumerable<Trit> aInputStates = null, IEnumerable<Trit> bInputStates = null, IEnumerable<Trit> carryInputStates = null) :
